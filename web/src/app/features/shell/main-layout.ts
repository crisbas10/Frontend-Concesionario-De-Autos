...
export class MainLayoutComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.usuarioService.list().subscribe({
      ...
      error: (err: HttpErrorResponse) => this.snack.open(this.msg(err), 'Cerrar', { duration: 5000 }),
    });
  }

  ngAfterViewInit(): void { this.syncContentMarginsWithDrawer(); }
  ...
  onUsuarioAudit(id: number): void { this.audit.select(id); }
